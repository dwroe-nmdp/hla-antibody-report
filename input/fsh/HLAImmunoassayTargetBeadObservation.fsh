Profile: HLAImmunoassayTargetBeadObservation
Parent: USCoreLaboratoryResultObservationProfile
Id: hla-immunoassay-target-bead-observation
Title: "HLA Immunoassay Target Bead Observation"
...
* ^url = "https://fhir.nmdp.org/ig/HlaAntibodyReport/StructureDefinition/hla-immunoassay-target-bead-observation"
* ^version = "0.1.0"
* ^status = #draft
* ^publisher = "NMDP"
